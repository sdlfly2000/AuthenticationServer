...
@UserAcceptanceTest @DeleteUserClaimSuccessful
Scenario: Delete User Claim Successful
	Given an DeleteUserClaimRequest with UserName "TestUser" with UserId: "daca6f11-8ca8-4cd9-8197-2068ac993dec", ClaimType: "Version", ClaimValue: "2.0.1"
