...
namespace Infra.Database.Migrations
{
    ...
    [Migration("20260219110345_ClaimConvertedToEntity")]
    partial class ClaimConvertedToEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Authorizations.Entities.Right", b =>
                {
            ...
            modelBuilder.Entity("Domain.Authorizations.Entities.Role", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(36)")
            ...
            modelBuilder.Entity("Domain.User.Entities.Claim", b =>
                {
            ...
            modelBuilder.Entity("RightRole", b =>
                {
                    b.HasOne("Domain.Authorizations.Entities.Right", null)
                        .WithMany()
                        .HasForeignKey("RightsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Authorizations.Entities.Role", null)
                        .WithMany()
